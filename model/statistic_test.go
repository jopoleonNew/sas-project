...
func TestSaveYandexStatistic(t *testing.T) {
	test := []yad.CampaignStat{
		{CampaignID: 123,
			ClicksContext: 123,
			ClicksSearch:  123,
			StatDate:      yad.YandexTime{time.Date(2017, time.September, 20, 23, 00, 00, 00, time.FixedZone("CET", 10800))},
			SumSearch:     123},
		{CampaignID: 123,
			ClicksContext: 13,
			StatDate:      yad.YandexTime{time.Now()},
			SumSearch:     13},
		//{CampaignID: 1323,
		//	ShowsSearch: 1723,
		//	StatDate:    yad.YandexTime{time.Date(2017, time.September, 20, 23, 00, 00, 00, time.FixedZone("CET", 10800))},
...
//		{CampaignID: 123,
//			ClicksContext: 13,
//			StatDate:      yad.YandexTime{time.Date(2017, time.September, 21, 23, 00, 00, 00, time.FixedZone("CET", 10800))},
//			SumSearch:     13},
//		{CampaignID: 1323,
//			ShowsSearch: 1723,
//			StatDate:    yad.YandexTime{time.Date(2017, time.September, 20, 23, 00, 00, 00, time.FixedZone("CET", 10800))},
